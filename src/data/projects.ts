...
const projectMeta: Record<string, ProjectMeta> = {
  'AUDI': { client: 'Audi', title: 'Audi Q7', disciplines: ['Magazine ads'], order: 1 },
  'Australis Music Group': { client: 'Australis', title: 'Orange Amplifiers brand guide and TAC event', disciplines: ['Branding', 'Events'], order: 2 },
  'Charlie Hair rollers': { client: 'Charlii', title: 'Charlii Hair Rollers', disciplines: ['Social', 'Campaign', 'Motion'], order: 3, featured: true, displayTheme: 'charlii' },
  'Elemental Studio': { client: 'Elemental', title: 'Elemental Studio logo and business cards', disciplines: ['Branding', 'Business cards'], order: 4 },
  'FaceitGraphix': { client: 'Faceit', title: 'Faceit Graphix branding and wrap', disciplines: ['Branding', 'Vehicle wraps'], order: 5 },
  'Hardtuned': { client: 'Hardtuned', title: 'Fashion EDM', disciplines: ['EDM', 'Editorial'], order: 6 },
  'Kean Construction group': { client: 'Kean', title: 'Organic social posts', disciplines: ['Social'], order: 7 },
  'Powertec': { client: 'Powertec', title: 'Magazine, social and packaging designs', disciplines: ['Magazine ads', 'Social', 'Packaging', 'Motion'], order: 8 },
  'Real Estate': { client: 'Real Estate', title: 'Brochure designs', disciplines: ['Brochures', 'Editorial'], order: 9 },
  'Spinal life': { client: 'Spinal', title: 'Organic social', disciplines: ['Social'], order: 10 },
  'The Brooklyn_Wine & Tapas Bar': { client: 'Brooklyn', title: 'Organic social', disciplines: ['Social'], order: 11 },
  'The Sycamore school': { client: 'Sycamore', title: 'Social ads', disciplines: ['Social', 'Campaign', 'Motion'], order: 12 },
  'UN': { client: 'UN', title: 'United Nations Covid-19 Campaign', disciplines: ['Magazine ads'], order: 13 },
  'Vetner': { client: 'Vetner', title: 'Social ads', disciplines: ['Social'], order: 14 },
  'All Day Workwear': { client: 'All Day Workwear', title: 'Campaign banners', disciplines: ['Social'], order: 15 },
}
